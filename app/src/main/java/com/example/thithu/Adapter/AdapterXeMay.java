...
public class AdapterXeMay extends RecyclerView.Adapter<AdapterXeMay.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvTenXe.setText("Tên xe:" + list.get(position).getTen_xe_ph44272());
        holder.tvMauSac.setText("Màu sắc: " + list.get(position).getMau_sac_ph44272());
        holder.tvGiaBan.setText("Giá bán: " + list.get(position).getGia_ban_ph44272());
        holder.tvMoTa.setText("Mô tả: " + list.get(position).getMo_ta_ph44272());
    ...
    private void Dialog_ChiTiet(XeMay xeMay) {
        ...
        tv_ten.setText("Tên xe: " + xeMay.getTen_xe_ph44272());
        tv_gia.setText("Màu sắc: " + xeMay.getGia_ban_ph44272());
        tv_mausac.setText("Màu sắc: " + xeMay.getMau_sac_ph44272());
        tv_mota.setText("Mô tả: " + xeMay.getMo_ta_ph44272());
